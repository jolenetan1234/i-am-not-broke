...
const ConfirmDelete = ({ id, handleDeleteClose, handleDeleteConfirm }) => {
  return (
            ...
            <div className="py-4 px-2 rounded-md shadow-lg border bg-white dark:bg-zinc-950 dark:border-gray-500 dark:shadow-lg">
                ...
                <div className="text flex flex-col h-full">
                    ...
                    h-1/3">
                        ...
                        <button className="shadow rounded-sm px-4 mx-2 text-sm font-medium bg-gray-300 hover:bg-gray-400 dark:bg-gray-400 dark:hover:bg-gray-500 dark:text-white"
